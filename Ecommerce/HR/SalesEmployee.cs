...
public class SalesEmployee : Employee{
    ...
    public SalesEmployee(int id,string firstName,string lastname,string email,
                        string contactNumber,string location,DateTime bDate,float da,
                        float hra,float bsal,float target,float salesDone):base(id,firstName,lastname, email, contactNumber,
